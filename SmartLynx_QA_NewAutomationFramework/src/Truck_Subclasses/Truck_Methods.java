...
public class Truck_Methods {
	...
	private static WebElement terminalmappingfirststatecheckbox=null;
...
public static WebElement metnumber(WebDriver driver) throws Exception{
	...
	metnumber=driver.findElement(By.id(ExcelUtils.getstringCellData(52, ColNum)));
...
public static WebElement metdiv(WebDriver driver) throws Exception{
	...
	metdiv=driver.findElement(By.xpath(ExcelUtils.getstringCellData(53, ColNum)));
...
public static WebElement defaultproductclick(WebDriver driver) throws Exception{
	...
	defaultproductclick=driver.findElement(By.xpath(ExcelUtils.getstringCellData(54, ColNum)));
...
public static WebElement defaultproductsearchbox(WebDriver driver) throws Exception{
	...
	defaultproductsearchbox=driver.findElement(By.id(ExcelUtils.getstringCellData(55, ColNum)));
...
public static WebElement defaultproductselect(WebDriver driver) throws Exception{
	...
	defaultproductselect=driver.findElement(By.xpath(ExcelUtils.getstringCellData(56, ColNum)));
...
public static WebElement defaultproductok(WebDriver driver) throws Exception{
	...
	defaultproductok=driver.findElement(By.id(ExcelUtils.getstringCellData(57, ColNum)));
...
public static WebElement typeactive(WebDriver driver) throws Exception{
	...
	typeactive=driver.findElement(By.xpath(ExcelUtils.getstringCellData(58, ColNum)));
...
public static WebElement typeclick(WebDriver driver) throws Exception{
	...
	typeclick=driver.findElement(By.xpath(ExcelUtils.getstringCellData(59, ColNum)));
...
public static WebElement reels(WebDriver driver) throws Exception{
	...
	reels=driver.findElement(By.linkText(ExcelUtils.getstringCellData(63, ColNum)));
...
public static WebElement reelsadd(WebDriver driver) throws Exception{
	...
	reelsadd=driver.findElement(By.xpath(ExcelUtils.getstringCellData(64, ColNum)));
...
public static WebElement reelsnumber(WebDriver driver) throws Exception{
	...
	reelsnumber=driver.findElement(By.id(ExcelUtils.getstringCellData(65, ColNum)));
...
public static WebElement reelsdiv(WebDriver driver) throws Exception{
	...
	reelsdiv=driver.findElement(By.xpath(ExcelUtils.getstringCellData(66, ColNum)));
...
public static WebElement flushvolumeactive(WebDriver driver) throws Exception{
	...
	flushvolumeactive=driver.findElement(By.xpath(ExcelUtils.getstringCellData(67, ColNum)));
...
public static WebElement terminalmappingfirststatecheckbox(WebDriver driver) throws Exception{
	
	terminalmappingfirststatecheckbox=driver.findElement(By.xpath(ExcelUtils.getstringCellData(89, ColNum)));
...
public static WebElement termtopcheck(WebDriver driver){
	...
	termtopcheck=driver.findElement(By.xpath("//li/ul/li/div/span/input"));
...
public static WebElement terminalmappingsecondstatecheckbox(WebDriver driver) throws Exception{
	...
	terminalmappingsecondstatecheckbox=driver.findElement(By.xpath(ExcelUtils.getstringCellData(90, ColNum)));
...
public static WebElement ok(WebDriver driver) throws Exception{
	...
	ok=driver.findElement(By.id(ExcelUtils.getstringCellData(185, ColNum)));
