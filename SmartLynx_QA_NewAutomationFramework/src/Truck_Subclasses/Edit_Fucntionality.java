...
/*		Truck_Methods.jbusodometeroffset(driver).clear();
		...
		((JavascriptExecutor)driver).executeScript("arguments[0].click();",Truck_Methods.metersnumberactive(driver));
		...
		Truck_Methods.metnumber(driver).sendKeys(String.valueOf(ExcelUtils.getintCellData(119, ColNum)));
		...
		Truck_Methods.defaultproductsearchbox(driver).sendKeys(ExcelUtils.getstringCellData(120, ColNum));
		...
		Truck_Methods.metnumber(driver).sendKeys(String.valueOf(ExcelUtils.getintCellData(123, ColNum)));
		...
		Truck_Methods.defaultproductsearchbox(driver).sendKeys(ExcelUtils.getstringCellData(124, ColNum));
		...
		((JavascriptExecutor)driver).executeScript("arguments[0].click();",Truck_Methods.reelsnumberactive(driver));
		...
		Truck_Methods.reelsnumber(driver).sendKeys(String.valueOf(ExcelUtils.getintCellData(128, ColNum)));
		...
		((JavascriptExecutor)driver).executeScript("arguments[0].click();",Truck_Methods.compartmentsnumberactive(driver));
		...
		Truck_Methods.compartmentsnumber(driver).sendKeys(String.valueOf(ExcelUtils.getintCellData(135, ColNum)));
		...
		Truck_Methods.editterminalmapping(driver).click();
