...
public class Orderhold_Methods {
...
public static WebElement ok(WebDriver driver) throws Exception{
	...
	if(element.getSize() != null){
		...
		ExcelUtils.setCellData("Orderhold Record Deleted Successfully", 25,7);
	 	
	 	ExcelUtils.setCellData("Pass", 34,8);
		
		System.out.println("Orderhold Record Deleted Successfully");
...
WebElement existdotdefectlist=driver.findElement(By.xpath(".//*[@id='OrderHoldGrid']/div[2]/table/tbody/tr/td[1]"));
	
	if(existdotdefectlist.isDisplayed()){
		
		ExcelUtils.setCellData("Orderhold ID "+existdotdefectlist.getText()+" is Already Existed", 22,8);	
		
		
		System.out.println("Orderhold ID  "+existdotdefectlist.getText()+ " is Already Existed");
		...
		ExcelUtils.setCellData("Orderhold ID "+existdotdefectlist.getText()+ " is not Existed", 22,8);	
		
		System.out.println("Orderhold  ID "+existdotdefectlist.getText()+ " is not Existed");
