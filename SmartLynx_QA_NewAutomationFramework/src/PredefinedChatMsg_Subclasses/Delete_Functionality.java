...
public class Delete_Functionality {
	...
	public static void predefinedchatmsg(WebDriver driver) throws Exception{
		...
		PredefinedChatMsg_Methods.delete(driver).click();

		Thread.sleep(3000);
		
		screenshot.CaptureScreenshot(driver);

		PredefinedChatMsg_Methods.deletealertcontent(driver);

		Thread.sleep(3000);
		
		screenshot.CaptureScreenshot(driver);

		PredefinedChatMsg_Methods.ok(driver).click();
		...
		PredefinedChatMsg_Methods.search(driver).sendKeys(Keys.DELETE);
